...
public class StringH2Filter extends H2FilterBase<String, TextFilterField> {

    @Override
    public void handle(final String columnName, final TextFilterField filterField, final H2ClauseCollection collection) {
