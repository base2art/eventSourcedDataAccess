...
public class CompareUtils {
    ...
    public static <T extends Comparable<T>, U extends SimpleComparableField<T>> boolean handleComparable(final T type, final U filterField) {
    ...
    public static <T, U extends SimpleComparableField<T>> boolean handleComparable(final T type, final U filterField, Comparator<T> comp) {
    ...
    public static <T, U extends SimpleEquatableField<T>> boolean handleEqual(final T type, final U filterField) {
