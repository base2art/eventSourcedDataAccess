...
public class H2EntityConnectorGenerator implements Generator {
    @Override
    public GeneratorContent generate(final ClassifiedGeneratableItem item) {
        return new GeneratorContent() {
            ...
            public String getFileName() {
                return "H2" + item.getOutputClassName() + "Connector.java";
            }

            @Override
            public String getContent() {

                return Resources.entityH2ConnectorTemplate(
                        item.getPackageName(),
