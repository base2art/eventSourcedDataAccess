...
public class InMemoryEntityWriterGenerator implements Generator {
    @Override
    public GeneratorContent generate(final ClassifiedGeneratableItem item) {
        return new GeneratorContent() {
            ...
            public String getFileName() {
                return "InMemory" + item.getOutputClassName() + "Writer.java";
            }

            @Override
            public String getContent() {

                return Resources.entityInMemoryWriterTemplate(
                        item.getPackageName(),
